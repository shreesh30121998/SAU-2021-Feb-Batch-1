        ...
        return(
            <div>
                <form onSubmit={this.handleSubmit}>
                    ...
                    <label for="bi">SNo.: </label>
                        <input type="text" name="bookid" value={bookid} id="bi" onChange={this.handleChange}/>
                    <br/><br/>
                    <label for="b">Enter book name: </label>
                        <input type="text" name="name" value={name} id="b" onChange={this.handleChange} placeholder="Name some classics"/>
                        <br/><br/>
                    <label for="tb">Describe: </label>
                        <textarea id="tb" name="description" value={description} onChange={this.handleChange} placeholder="About the book" rows="10" cols="50" />
                        <br/> <br/>
